...
export const services = [
  {slug:'experience-design-enablement', name:'Experience Design & Enablement', short:'Experience', number:'001', phrase:'Experiences that bring people closer.', description:'Design and build connected digital experiences, customer journeys, websites, applications and personalized content around the people who use them.', eyebrow:'START WITH PEOPLE', areas:['Customer journey strategy','Websites & digital applications','UX, UI & content experiences','Personalization & optimization'], output:'A clearer journey, a purposeful experience and the design and engineering to bring it to life.', link:'Technology makes the experience possible. Intelligence makes it more relevant.', adjacent:1},
  {slug:'martech-consulting-enablement', name:'MarTech Consulting & Enablement', short:'Technology', number:'002', phrase:'Make your technology work together.', description:'Assess, architect, implement, integrate and improve the platforms behind modern marketing, CRM and customer engagement.', eyebrow:'CONNECT THE SYSTEM', areas:['MarTech assessment & architecture','Platform implementation & integration','CRM & marketing automation','Campaigns, journeys & optimization'], output:'A connected marketing ecosystem with clear ownership, useful workflows and platforms your teams can put to work.', link:'Experience gives technology its purpose. Intelligence guides what happens next.', adjacent:2},
  {slug:'data-intelligence-activation', name:'Data Intelligence & Activation', short:'Intelligence', number:'003', phrase:'From customer data to a useful next step.', description:'Unify, understand and activate customer and business data through segmentation, analytics, CDP, measurement and actionable intelligence.', eyebrow:'TURN SIGNALS INTO ACTION', areas:['Customer data & CDP consulting','Data quality & identity','Analytics, measurement & segmentation','Personalization & activation'], output:'Trusted customer context, a shared way to measure progress and intelligence that informs real decisions.', link:'Technology connects the data. Experience is where its value becomes visible.', adjacent:0}
];
